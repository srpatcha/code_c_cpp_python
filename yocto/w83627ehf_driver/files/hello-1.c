 ...
 * Copyright (c) 2018, JCI Inc.
 *
 * This program is driver software; you can redistribute it and/or modify it
 ...
 * more details.
 *
 * You should have received a copy of code the along with
 * this program; if not, write to the JCI, Inc.
 */
...
static void pkg_temp_thermal_threshold_work_fn(struct work_struct *work)
{
	 ...
	 */
	if (tzone)
		thermal_zone_device_update(tzone);
...
MODULE_AUTHOR("Srikanth patchava<jpatchs@jci.com>");
MODULE_LICENSE("GPL");
